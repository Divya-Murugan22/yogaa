...
const Pricing = () => {
  ...
  const PricingCard = ({ title, price, description, features, isPopular, buttonLabel }) => (
    <div className={`pricing-card ${isPopular ? "popular" : ""}`}>
      ...
      <button className="animate-btn-5" >Get Started
        <div class="animate-extra-bar-left-5"></div>
        <div class="animate-extra-bar-right-5"></div>
  ...
  const ShortTermPlanCard = ({ title, price, description, features, buttonLabel }) => (
    <div className="short-term-plan">
      ...
      <button className="animate-btn-5" >Buy Now
        <div class="animate-extra-bar-left-5"></div>
        <div class="animate-extra-bar-right-5"></div>
