...
const ContactPage = () => {
 ...
 <h2 style={{fontSize:"40px",marginLeft:"0px",
  fontFamily: "Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif",color:"#440961"}}>Reach Out</h2>
...
<div className="contact-form" style={{ maxWidth: "700px", margin: "0 auto", marginRight:"40px" }}>
  <form onSubmit={handleSubmit}>
    ...
    >
      ...
      />
      <label htmlFor="newsletter" style={{ fontSize: "14px",marginLeft:"-10px" }}>
    ...
    <button
      ...
      style={{
        padding: "20px",
        width:'100%', // Adjusted button padding
        fontSize: "16px",
...
>
  ...
  >
    ...
    >
      ...
      >
        <p style={{ lineHeight: "2.0", color: "#FFFFFF", fontSize: 20 , fontWeight:'bold', letterSpacing:"1px"}}>
          Address:
        </p>
        <p
          style={{
